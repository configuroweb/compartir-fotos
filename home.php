...
<style>
    ...
    .pImg-holder .carousel-item,
    .pImg-holder .carousel-item img,
    .pImg-holder .carousel,
    .pImg-holder .carousel-inner {
        width: calc(100%);
        height: calc(100%);
    }
            ...
            <div class="card mt-4 mb-4 posts">
                <div class="card-body" style="padding-left: unset;padding-right:unset" data-id="<?php echo $row['id'] ?>">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-11">
                                <textarea name="comment[<?php echo $row['id'] ?>]" cols="30" rows="1" class="form-control cmt-field" placeholder="Escribe un comentario"></textarea>
                            </div>
...
<div class="comment_clone" style="display: none">
    <div class="comment">
        <div class="col-md-12">
            <p><b class="usr"><i>Usuario de muestra</i></b> <small class="dt">Jun 14,2023</small><br><small class="cntnt">woowwww.....</small></p>
            <hr>
        </div>
    </div>
</div>
